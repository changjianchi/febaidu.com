...
## 产品周报
* 民生
    * 笑话阿拉丁：走单中，预计8.19上线 @晓卉
    * 春节sigma 2.0迁移：开发中，预计8.17上线 @德丹
    * 颜色问答sigma 2.0迁移：未开始 @晓卉
    * 自杀 sigma 2.0迁移：预计8.19完成上线 @鹏远
* 影视
    * 电影精需求：8.5小流量上线（无更新） @德丹
    * 精准影院卡sigma 2.0迁移：开发中，预计8.24完成开发 @黄睿
    * 影视宣发sigma 2.0迁移：8.19开发完成 @健驰
* 自有产品
    * 图片抽样模板优化-大图页：数据接口评估中 @姿艳
...
* 通用
    * showlamp长线方案：评审中 @小琴
* 问题
    * sigma开发有可能涉及sigma卡，白卡和退化卡，成本略高，现对线上sigma样式进行梳理：[详情](http://ala-fe.baidu.com/demandspace/v_qipengyuan.md) 
...
* 问题
    ...
    * <span style="color: green;">转码-odp拆卡的模板进行转码 @轶婵 （*8.19已开100%外网流量*）</span>
...
* 推动各垂类下线近30天无展现的模板
    * 目前还有320个无人认领，正在找pm后台的rd帮忙跑下资源配置和pm信息，方便下一步推动
