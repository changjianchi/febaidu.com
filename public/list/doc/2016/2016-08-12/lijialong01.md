...
* <span style="color:red;">基本完成接口测试内容, 和雨梅对一下内容测试的方案.</span>

## 修复sf2.0点击日志clk_info的bug

### 背景

* 点击日志加入xpath时参数传递错误,导致重复

### 完成情况

* <span style="color:red;">8.11日已上线</span>
...
* <span>7.28日 已上线</span>
* <span>修复异步打开sf2.0的情况下,有2分webb的逻辑. 8.3日志上线 </span>
* <span style="color:red;">修复日志参数逻辑, 8.11日志上线</span>


## 结果页交互日志添加cyc,is_mip统计
...
* <span style="color:red;">8.10日志 已上线</span>
...
* <span style="color:red;">修复一个bug,继续实验</span>
