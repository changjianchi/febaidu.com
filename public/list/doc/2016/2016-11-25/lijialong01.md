...
* <span style="color:red;">最新测试报告，符合8.1版本预期。费东提供了单pv时长统计的脚本，qa下周产出时长统计<span>
...
* <span style="color:red;">基本开发完毕，下周qa接入测试</span>
...
* 目前同步情景页并有统计媒体时长，同步页的流量将会越来越大，产品方也有需求。需要加上同步页的媒体时长
...
* 与以前视频中间页的方案相同，owb页面，qid为来源qid，applid为当前页id，pid为产品标识。

* ubs这边只给单pv的媒体时长，以qid对齐。如果要具体的情景页时长，自行通过applid merge pd 区分。

* 同步页webb，目前的方案，是必须有qid，没有qid则不发送。如果以后有没有qid的产品，再做开放。
